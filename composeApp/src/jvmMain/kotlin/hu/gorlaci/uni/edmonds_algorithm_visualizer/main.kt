...
private fun addExampleGraphs( graphStorage: InMemoryGraphStorage ){
    addExampleGraph1(graphStorage)
    addExampleGraph2(graphStorage)
}

private fun addExampleGraph1( graphStorage: InMemoryGraphStorage ){
    val graph = Graph(
...
private fun addExampleGraph2( graphStorage: InMemoryGraphStorage ){
    val graph = Graph(
        vertices = mutableListOf(
            Vertex(id = "A"),
            Vertex(id = "B"),
